...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Toml.swiftmodule/`
...
//      `import Toml` above would fail at compile time.
//
//   2. The static archive `libToml.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Toml" }` and
//      `flattenPackage = "io.github.kotlinmania.toml"` configuration in
...
final class TomlExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Toml swift module imported cleanly")
    }
}
