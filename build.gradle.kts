...
kotlin {
    ...
    swiftExport {
        moduleName = "Toml"
        flattenPackage = "io.github.kotlinmania.toml"
    }

    android {
        namespace = "io.github.kotlinmania.toml"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "toml-kotlin", version.toString())

    pom {
        name.set("toml-kotlin")
        description.set("Kotlin Multiplatform port of toml-rs/toml - A native Rust encoder and decoder of TOML-formatted files and streams. Provides implementations of the standard Serialize/Deserialize traits for TOML data to facilitate deserializing and serializing Rust structures")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/toml-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/toml-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/toml-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/toml-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTomlXCFramework",
    "assembleTomlDebugXCFramework",
    "assembleTomlReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTomlXCFramework",
    "assembleReleaseIosFatFrameworkForTomlXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTomlXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTomlXCFramework",
    "assembleDebugMacosFatFrameworkForTomlXCFramework",
    "assembleReleaseMacosFatFrameworkForTomlXCFramework",
    "assembleDebugTvosFatFrameworkForTomlXCFramework",
    "assembleReleaseTvosFatFrameworkForTomlXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTomlXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTomlXCFramework",
    "assembleDebugWatchosFatFrameworkForTomlXCFramework",
    "assembleReleaseWatchosFatFrameworkForTomlXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTomlXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTomlXCFramework",
