...
- **Function parity:** 107/519 matched (target 241) — 20.6%
- **Class/type parity:** 30/166 matched (target 69) — 18.1%
- **Combined symbol parity:** 137/685 matched (target 310) — 20.0%
...
- **Missing types:** `TomlSink`
- **Tests:** 8/8 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/error.rs` vs expected `de/error.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/de/error.rs` vs expected `de/error.rs`
- **Proposed provenance header:** `// port-lint: source de/error.rs` (current: `// port-lint: source toml/src/de/error.rs`)
- **Proposed provenance header:** `// port-lint: tests de/error.rs` (current: `// port-lint: tests toml/src/de/error.rs`)
- **Lint issues:** 2
...
- **Types:** 4/7 matched (target 15)
- **Missing types:** `DeString`, `Output`, `Sealed`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/devalue.rs` vs expected `de/parser/devalue.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/de/parser/devalue.rs` vs expected `de/parser/devalue.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/devalue.rs` (current: `// port-lint: source toml/src/de/parser/devalue.rs`)
- **Proposed provenance header:** `// port-lint: tests de/parser/devalue.rs` (current: `// port-lint: tests toml/src/de/parser/devalue.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/detable.rs` vs expected `de/parser/detable.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/de/parser/detable.rs` vs expected `de/parser/detable.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/detable.rs` (current: `// port-lint: source toml/src/de/parser/detable.rs`)
- **Proposed provenance header:** `// port-lint: tests de/parser/detable.rs` (current: `// port-lint: tests toml/src/de/parser/detable.rs`)
- **Lint issues:** 2
...
- **Types:** 1/1 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/style.rs` vs expected `ser/style.rs`
- **Proposed provenance header:** `// port-lint: source ser/style.rs` (current: `// port-lint: source toml/src/ser/style.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/table.rs` vs expected `table.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/table.rs` vs expected `table.rs`
- **Proposed provenance header:** `// port-lint: source table.rs` (current: `// port-lint: source toml/src/table.rs`)
- **Proposed provenance header:** `// port-lint: tests table.rs` (current: `// port-lint: tests toml/src/table.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/dearray.rs` vs expected `de/parser/dearray.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/de/parser/dearray.rs` vs expected `de/parser/dearray.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/dearray.rs` (current: `// port-lint: source toml/src/de/parser/dearray.rs`)
- **Proposed provenance header:** `// port-lint: tests de/parser/dearray.rs` (current: `// port-lint: tests toml/src/de/parser/dearray.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/value.rs` vs expected `value.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/value.rs` vs expected `value.rs`
- **Proposed provenance header:** `// port-lint: source value.rs` (current: `// port-lint: source toml/src/value.rs`)
- **Proposed provenance header:** `// port-lint: tests value.rs` (current: `// port-lint: tests toml/src/value.rs`)
- **Lint issues:** 2
...
- **Types:** 2/2 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/document/buffer.rs` vs expected `ser/document/buffer.rs`
- **Proposed provenance header:** `// port-lint: source ser/document/buffer.rs` (current: `// port-lint: source toml/src/ser/document/buffer.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/map.rs` vs expected `map.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/map.rs` vs expected `map.rs`
- **Proposed provenance header:** `// port-lint: source map.rs` (current: `// port-lint: source toml/src/map.rs`)
- **Proposed provenance header:** `// port-lint: tests map.rs` (current: `// port-lint: tests toml/src/map.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/document/strategy.rs` vs expected `ser/document/strategy.rs`
- **Proposed provenance header:** `// port-lint: source ser/document/strategy.rs` (current: `// port-lint: source toml/src/ser/document/strategy.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/value/map.rs` vs expected `ser/value/map.rs`
- **Proposed provenance header:** `// port-lint: source ser/value/map.rs` (current: `// port-lint: source toml/src/ser/value/map.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/document/array_of_tables.rs` vs expected `ser/document/array_of_tables.rs`
- **Proposed provenance header:** `// port-lint: source ser/document/array_of_tables.rs` (current: `// port-lint: source toml/src/ser/document/array_of_tables.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/value/key.rs` vs expected `ser/value/key.rs`
- **Proposed provenance header:** `// port-lint: source ser/value/key.rs` (current: `// port-lint: source toml/src/ser/value/key.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/deserializer/key.rs` vs expected `de/deserializer/key.rs`
- **Proposed provenance header:** `// port-lint: source de/deserializer/key.rs` (current: `// port-lint: source toml/src/de/deserializer/key.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/deserializer/value.rs` vs expected `de/deserializer/value.rs`
- **Proposed provenance header:** `// port-lint: source de/deserializer/value.rs` (current: `// port-lint: source toml/src/de/deserializer/value.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/deserializer/table.rs` vs expected `de/deserializer/table.rs`
- **Proposed provenance header:** `// port-lint: source de/deserializer/table.rs` (current: `// port-lint: source toml/src/de/deserializer/table.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/debug.rs` vs expected `de/parser/debug.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/debug.rs` (current: `// port-lint: source toml/src/de/parser/debug.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/document.rs` vs expected `de/parser/document.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/document.rs` (current: `// port-lint: source toml/src/de/parser/document.rs`)
- **Lint issues:** 1
...
- **Types:** 0/1 matched
- **Missing types:** `State`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/inline_table.rs` vs expected `de/parser/inline_table.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/inline_table.rs` (current: `// port-lint: source toml/src/de/parser/inline_table.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/value/array.rs` vs expected `ser/value/array.rs`
- **Proposed provenance header:** `// port-lint: source ser/value/array.rs` (current: `// port-lint: source toml/src/ser/value/array.rs`)
- **Lint issues:** 1
...
- **Types:** 0/1 matched
- **Missing types:** `State`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/array.rs` vs expected `de/parser/array.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/array.rs` (current: `// port-lint: source toml/src/de/parser/array.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/deserializer/array.rs` vs expected `de/deserializer/array.rs`
- **Proposed provenance header:** `// port-lint: source de/deserializer/array.rs` (current: `// port-lint: source toml/src/de/deserializer/array.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/document/map.rs` vs expected `ser/document/map.rs`
- **Proposed provenance header:** `// port-lint: source ser/document/map.rs` (current: `// port-lint: source toml/src/ser/document/map.rs`)
- **Lint issues:** 1
...
- **Types:** 0/1 matched
- **Missing types:** `State`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/key.rs` vs expected `de/parser/key.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/key.rs` (current: `// port-lint: source toml/src/de/parser/key.rs`)
- **Lint issues:** 1
...
- **Missing types:** `Error`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/deserializer/table_enum.rs` vs expected `de/deserializer/table_enum.rs`
- **Proposed provenance header:** `// port-lint: source de/deserializer/table_enum.rs` (current: `// port-lint: source toml/src/de/deserializer/table_enum.rs`)
- **Lint issues:** 1
...
- **Types:** 1/3 matched (target 1)
- **Missing types:** `Ok`, `Error`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/document/array.rs` vs expected `ser/document/array.rs`
- **Proposed provenance header:** `// port-lint: source ser/document/array.rs` (current: `// port-lint: source toml/src/ser/document/array.rs`)
- **Lint issues:** 1
...
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/ser/error.rs` vs expected `ser/error.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:toml/src/ser/error.rs` vs expected `ser/error.rs`
- **Proposed provenance header:** `// port-lint: source ser/error.rs` (current: `// port-lint: source toml/src/ser/error.rs`)
- **Proposed provenance header:** `// port-lint: tests ser/error.rs` (current: `// port-lint: tests toml/src/ser/error.rs`)
- **Lint issues:** 2

### 28. macros

- **Target:** `toml.Macros [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Types:** 0/0 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/macros.rs` vs expected `macros.rs`
- **Proposed provenance header:** `// port-lint: source macros.rs` (current: `// port-lint: source toml/src/macros.rs`)
- **Lint issues:** 1
...
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `toml/src/de/parser/value.rs` vs expected `de/parser/value.rs`
- **Proposed provenance header:** `// port-lint: source de/parser/value.rs` (current: `// port-lint: source toml/src/de/parser/value.rs`)
- **Lint issues:** 1
