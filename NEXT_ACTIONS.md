...
| Source | Target | Path |
|--------|--------|------|
| `value.mod` | `value.ValueSerializer` | `src/ser/value/mod` |
| `document.mod` | `document.Serializer` | `src/ser/document/mod` |
| `deserializer.mod` | `de.Deserializer` | `src/de/deserializer/mod` |
| `macros` | `toml.Macros` | `src/macros` |
| `lib` | `toml.Lib` | `src/lib` |
| `ser.mod` | `ser.Serializer` | `src/ser/mod` |
