...
This file is the quick-reference operating contract for toml-kotlin. The longer
...
toml-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`toml`](https://crates.io/crates/toml). Upstream Rust is the behavioral oracle while the
